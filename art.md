...
作为优秀的设计,都可以在对齐的对象间画出“对齐线”,即使这些设计总体表现 为汇集了大量奇特的内容,甚至动感十足,这种“对齐线”也很明确。

# 298

在得到更多培训之前,一定要坚持一个原则:只  使用一种对齐方式。
...
这里用瘦高的纸(可能只有半张信纸大小) 强调一种细长条式的居中布局。

用宽而短的纸强调一种宽型的居 中布局。在下一个传单设计中可以 尝试让文本斜向一边。
...
1. 对比
对比的基本思想是,要避免页面上的元素太过相似。如果元素(字体、 颜色、大小、线宽、形状、空间等)不相同,那就干脆让它们截然不  同。要让页面引人注目,对比通常是最重要的一个因素,正是它能使读  者首先看这个页面。
2. 重复
让设计中的视觉要素在整个作品中重复出现。可以重复颜色、形状、材 质、空间关系、线宽、字体、大小和图片,等等。这样一来,既能增加 条理性,还可以加强统一性。
3. 对齐
任何东西都不能在页面上随意安放。每个元素都应当与页面上的另一个 元素有某种视觉联系。这样能建立一种清晰、精巧而且清爽的外观。
4. 亲密性
彼此相关的项应当靠近,归组在一起。如果多个项相互之间存在很近的 亲密性,它们就会成为一个视觉单元,而不是多个孤立的元素。这有助 于组织信息,减少混乱,为读者提供清晰的结构。
...
在你收集这方面的材料时，要用某种系统化的方法把它们分门别类的保存起来，就像我们已经将过的照片的收集方法一样，并按照不同的表现方面进行归类。
...
作为物品的边缘线，它们可能是很重要的，但比起投影廓线来，它们又显得是不够重要了。
...
S图则完全是使用垂直线画成，包括阴影也是如此。它在一定程度上有敞开口子的盒子的效果，因为其顶部的色调很容易被误解为是盒子内部的背面和侧面。
...
不要简单的满足只是浏览一下这类画作，要用心分析琢磨它，研究其使用到的不同类型线条以及手写部分和仪器绘制部分的不同特点和作者所用到的表现方法。

# 284

这是用轮廓线画物体的一个实用的方法：

1. 用铅笔勾勒出物体的主要比例并进行修改加工；
2. 在局部进行小的增补和修改；
3. 完成的轮廓线
4. 给轮廓线着墨，擦去铅笔线条，在魔水线条上做最后的润饰。

# 283

总的来说，要尽力去寻找美丽的事物，因为在多数情况下，研究美丽的事物要比普通事物获益更多。
...
中国画十二色颜料包括钛白、藤黄、朱砂、朱标、曙红、胭脂、花青、三青、三绿、酞青蓝、赭石和墨黑
...
正想训练有素的音乐家也需要常常练习音阶以及进行类似的工作以保持乐感一样，许多有经验的画家也常把空闲时间用于素描写生上，就是为了巩固已经属于他们的各种技能。
...
选好了对象，下一个任务就是在动手作画之前对写生对象做一个全面的分析。它最重要的属性是什么？它大还是小？它在色调上是亮还是暗？它表面是粗糙还是光滑？它的边缘是规则还是不规则的？这种分析所花的时间的长短取决于对象本身的丰富程度和你自己的能力。你应该凭现有的一点经验，学会几乎是瞥一眼就能把握住其造型、色彩、明暗对比、纹理和外表特征。
...
在自然界，物体色态的变化过程是先从暗色开始，逐渐增加亮色，直至最后达到最高亮度，而阴影和背影差不多维持原有状态，只是由于反射光而略显亮一些。在钢笔画上，画家的通常所为与上述程序正好相反，甚至是在追求写实效果时也是若此：他先从白纸开始，让它来表现最亮的物体表面；然后他用钢笔添加上阴影和背影。换句话说，他是用涂黑的块面来表现阴影和背影，而让白纸来代表亮色，但在自然界中却正好相反，是光源所照射的地方才有亮色，而物体的其他部分几乎仍只是最初的暗色。
...
画一组画面时，只需要让每张画面的线条连贯、流畅效果就打不一样。
...
当人们问及杰出的小提琴演奏家伊萨克·斯特恩(Issac Stern)如何区分伟大作品和盖世作品时，他说是交流能力。

# 191

作品中只加入服务主题的元素，成为电影绘画语言的基本基本原理。

# 190

温莎·麦凯习惯独立工作，在1911年到1921年这段时间里，他完成了多部惊人的电影作品，其中一些卡通人物相当真实，以致有人指责他是通过描摹照片来绘画的。

# 189

如果我们成功实现了这一点，观众就会非常在意角色本身，关注接下来将发生的事情。

# 188

在一个特定的故事情景中，我们很容易看到角色的性格变化能让枯燥的行为变得有趣。
...
任何艺术形式的表达，其本质都是传达一种特定情感。

# 185

问题在于动画不仅仅是某一单一的元素。它不仅仅是一种节奏，或者某个著名的角色形象，而是所有元素的集合。
